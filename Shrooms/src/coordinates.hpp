...
#define PIXEL_X_RANGE (EAST_PIXEL_X - WEST_PIXEL_X)
#define PIXEL_Y_RANGE (SOUTH_PIXEL_Y - NORTH_PIXEL_Y)
#define PIXEL_PER_LONG (PIXEL_X_RANGE / LONG_RANGE)
#define PIXEL_PER_LAT (PIXEL_Y_RANGE / LAT_RANGE)
